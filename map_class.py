...
class Map:
    ...
    def __init__(self, occupancy_map, start, end):
    ...
    def _create_nodes(self):
        ...
        return [[self.Nodes(i, j, self.occupancy_map, self.occupancy_map[i][j]) for j in
                 range(self.occupancy_map.shape[1])] for i in range(self.occupancy_map.shape[0])]
